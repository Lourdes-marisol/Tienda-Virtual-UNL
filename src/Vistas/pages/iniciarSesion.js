        ...
        <body>
            ...
            <div className="contenedor">
                ...
                <div className="form">
                    ...
                    <input className="txtCorreo" type="email" placeholder="Ingrese su correo electronico">
                    </input>
                    <br></br>
                    <div className="clave">
                    ...
                    <input className="txtClave" type="password" placeholder="Ingrese su contraseña">
                    </input>
                    <div className="boton">
                        ...
                        <br></br>
                        <h6 className="texto">No estas registrado? Regsitrate!</h6><br></br>
